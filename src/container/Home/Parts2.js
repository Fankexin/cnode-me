...
export default class Parts2 extends Component {
    constructor() {
        super();
        this.state = {
            data: []
    ...
    componentDidMount() {
        ...
        let url = `https://cnodejs.org/api/v1/topics?tab=good&page=${this.props.match.params.id}`;
